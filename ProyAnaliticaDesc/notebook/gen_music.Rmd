...
datos_filtrados <- subset(data_artistas, !is.na(stilo) & stilo != "")#elimino las filas con solo ""
...
nombres_artistas <- c("Bad Bunny","Maluma", "Shakira", "Karol G","J. Balvin","Camilo","Carlos Vives","Daddy Yankee","Miley Cyrus","Hannah Montana","Maroon 5","Morat","Blackpink")
...
plot(1, type = "n", xlim = c(0, 2), ylim = c(0, 2), xlab = "", ylab = "")

# Colocar la imagen en el gráfico con un tamaño más grande
rasterImage(imagen, 0, 0, 2, 2)
