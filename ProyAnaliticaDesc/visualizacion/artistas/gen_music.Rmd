...
jdsjdhjd
```{r}
# Cargar la librería 'mlbench' si no está instalada
if (!require(mlbench)) {
...
# Crear un dataframe con los datos X
X <- as.data.frame(CaliforniaHousing[, -9]) # Excluir la última columna (target)

# Crear una serie con los datos de la variable objetivo y
y <- CaliforniaHousing[, 9] # Última columna (target)
