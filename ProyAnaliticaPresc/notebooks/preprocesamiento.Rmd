...
write.csv(nuevo_df, file = "C:/Proyecto AQI/datos/calidad_aire4.csv", row.names = FALSE)
head(nuevo_df,10)
...
(c) Archivos generales a un solo archivo
```{r}
...
# Autenticar y acceder a la unidad de Google Drive
drive_auth()
drive_find(n_max = 10)  # Listar los archivos en Google Drive (hasta 10)

# Leer un archivo CSV de Google Drive
archivo <- drive_get(file = "ruta_del_archivo.csv")
datos <- read.csv(archivo)

# Realizar operaciones con los datos...

# Escribir un archivo CSV en Google Drive
write.csv(datos, file = " https://drive.google.com/file/d/1U4_wdgv9kOctFlnK1DMUxbOPTfLfAywF/view?usp=drive_link")
